...
petik = '```'
fake = 'CREATOR BOT\©AldoMayzacky'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/yudha.jpg')
        }}}
       const math = (teks) => {
      ...
      const hideTag = async function(from, text){
	       ...
	       dha.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/yudha.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
...
wa.me/6285776436511`
			...
			case 'order':
              ...
              buttonsMessage = {footerText:'PROSES 5-15MENIT', imageMessage: imageMsg,
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`DHA BOTZ ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN ALDO BOTZ」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
case 'tahta':
         ...
         break    
case 'pornhub':
         if (args.length == 0) return reply(`Contoh: ${prefix + command} DHA BOTZ`)
         txt1 = args[0]
         txt2 = args[1]
...
dha.sendMessage(from, {text:teks, jpegThumbnail:fs.readFileSync('./media/ganteng.jpg')}, 'extendedTextMessage', {sendEphemeral:true, quoted:mek, contextInfo:{ forwardingScore:508, isForwarded:true, mentionedJid:[senderr]}})
}
	} 
